...
# Initialize S3 client (using IAM role instead of hardcoded credentials)
s3 = boto3.client('s3')
...
def send_verification_email(email, first_name, verification_token):
    ...
    try:
        ...
        # Send email using IAM role authentication
        sender_email = os.environ.get('SES_SENDER_EMAIL', 'noreply@your-domain.com')
        sender_name = os.environ.get('SES_SENDER_NAME', 'Your App Name')
